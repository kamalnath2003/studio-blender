...
class KamalPanel(Panel):
    bl_label = "Kamal Panel"
    bl_idname = "OBJECT_PT_kamal_panel"
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator("object.create_shape", text="Create Cube")
        layout.operator("object.create_shape", text="Create Sphere").shape_type = 'SPHERE'

def register():
    register_class(KamalPanel)
